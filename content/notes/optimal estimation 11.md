...
<div style="display: flex; justify-content: space-around;"> <div> <img src="../static/notes/ex7_oeds10.png" alt="example 1 from the book" width="350" height="300"> </div> <div> <img src="../static/notes/ex7_oeds12.png" alt="example 2 from the book" width="350" height="300"> </div> </div>

The plots reveal a trajectory and uncertainty region comparison between time-variant $\phi_0$ EKF (left) and PF (right) for 10000 iterations. 