...
source: [RocketBoards](https://www.rocketboards.org/foswiki/Documentation/DE10NanoDevelopmentBoard)
...
Regarding Real-Time constraints, both are capable of securing such performances. However, we learned in [[asdfr|ASDfR]] that RPi requires a special library (evl) to access the only core assigned for real-time processes via the Xenomai framework, which might include additional effort on the software side for RPi.
...
sources: [ICE40](https://eu.mouser.com/new/lattice-semiconductor/lattice-ice40-FPGA/), [Cyclone V](https://www.terasic.com.tw/cgi-bin/page/archive.pl?Language=English&CategoryNo=167&No=1046), [short guideline](https://www.vemeko.com/blog/67171.html)
...
sources: [FPGA best practices guide](https://docs.altera.com/r/docs/683176/18.1/fpga-sdk-for-opencl-standard-edition-best-practices-guide/introduction-to-standard-edition-best-practices-guide)
...
>[!quote] You can also implement multiplication directly in logic (LUTs and flip-flops), but it takes significant resources. Using dedicated DSP blocks for multiplication makes sense from a performance and logic-use perspective. Hence, even small FPGAs dedicate space to DSP blocks.
>
>[source](https://projectf.io/posts/multiplication-fpga-dsps/)
...
Source: [edge ai vision](https://www.edge-ai-vision.com/2021/05/what-is-intelligent-photography-part-iii-understanding-different-image-file-formats-and-the-mysterious-yuv/)
